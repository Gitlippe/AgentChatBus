        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "agent_id":    {"type": "string",
                                    "description": "Optional: existing agent_id for session resumption (use with token)."},
                    "token":       {"type": "string",
                                    "description": "Optional: agent token for session resumption (use with agent_id)."},
                    "description": {"type": "string",
                                    "description": "Optional: agent description for new registration."},
                    "capabilities": {"type": "array", "items": {"type": "string"},
                                     "description": "Optional: capability tags for new registration, e.g. ['code', 'review', 'security']."},
                    "display_name": {"type": "string",
                                     "description": "Optional: human-friendly alias for new registration."},
                    "skills": {
                        "type": "array",
